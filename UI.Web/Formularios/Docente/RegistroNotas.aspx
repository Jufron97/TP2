...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
 <asp:Panel runat="server" style="border: 1px solid #000; width: 100%; height:80%; left:0%;position:relative;">
    ...
    <asp:Panel runat="server">
        ...
        <br/>
    <asp:Panel ID="formPanel" HorizontalAlign="Center" CssClass="align-content-center" runat="server" Visible="false">  
        ...
        <div class="form-group">
        <br/>           
        <asp:LinkButton ID="btnAceptar" runat="server" OnClick="btnAceptar_Click" Text="Aceptar"></asp:LinkButton>           
        <asp:LinkButton ID="btnCancelar" runat="server" OnClick="btnCancelar_Click" Text="Cancelar"></asp:LinkButton>  
            </div>
    </asp:Panel> 
    <asp:Panel ID="gridPanelFormCorregir" Visible="false" HorizontalAlign="Center" runat="server">        
    </asp:Panel>
        <div class="form-group">
        <asp:ValidationSummary ID="valSummary" ValidationGroup="1" runat="server" />
            </div>
 </asp:Panel>
</div>
     </asp:Panel>
